   ...
   <header className='absolute w-full z-50 transition-all duration-300'>
    ...
    lg:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="lg:flex hidden space-x-8">
            {["Home", "About","Projects","Experience","Certificates","Contact"].map((item,index)=>(
        ...
        className="md:hidden overflow-hidden bg-white dark:bg-gray-900 shadow-lg px-4 py-5 space-y-1">
            <nav className="flex flex-col space-y-3">
                {["Home", "About","Projects", "Experience","Certificates","Contact"].map((item,index) =>(
                    <a 
                    onClick={toggleMenu}
                    className=" text-gray-300 font-medium-full py-2"
                    key={index} 
                    href="#"
                    >
                    {item}
